...
$INSTALL/pyhton/2714/install/bin/python $START_PATH/plot_rho_outand.py --work=$INPUT_PATH/$TAG/test2_beo_epiff/allzones_e0.1/	 --outpath=$OUTPUT_PATH/$TAG/test2_beo_epiff/allzones_e0.1/rho
