...
$INSTALL/pyhton/2714/install/bin/python $START_PATH/run_rho2_outand_ellipfilter.py --file=$START_PATH/ally3.riz --tag=$TAG --work=$INPUT_PATH/$TAG --outpath=$OUTPUT_PATH/$TAG/test2_beo_e/allzones_e0.16 --bands=riz --threshold=0.16 --use_reserved #--bandcombo
