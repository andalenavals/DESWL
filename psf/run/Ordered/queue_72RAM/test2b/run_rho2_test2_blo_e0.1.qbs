...
$INSTALL/pyhton/2714/install/bin/python $START_PATH/run_rho2_outand_ellipfilter_piff.py --file=$START_PATH/ally3.riz --tag=$TAG --work=$INPUT_PATH/$TAG --outpath=$OUTPUT_PATH/$TAG/test2_beo_epiff/allzones_e0.1 --bands=riz --threshold=0.1 --use_reserved #--bandcombo
