...
$INSTALL/pyhton/2714/install/bin/python $START_PATH/run_rho2_outand.py --file=$START_PATH/run/Ordered/queue_144RAM/test1/ally3_e0.11.riz --tag=$TAG --work=$INPUT_PATH/$TAG --outpath=$OUTPUT_PATH/$TAG/test1_bee_e/ally3_e0.11 --bands=riz --use_reserved ###--bandcombo
