...
while read n
do
    $INSTALL/pyhton/2714/install/bin/python $START_PATH/run_rho2_outand.py --exps=$n --tag=$TAG --work=$INPUT_PATH/$TAG --outpath=$OUTPUT_PATH/$TAG/byexp/$n/     
    wait
done < $START_PATH/ally3.riz
