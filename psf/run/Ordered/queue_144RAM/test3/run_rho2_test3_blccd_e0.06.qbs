...
$INSTALL/pyhton/2714/install/bin/python $START_PATH/run_rho2_outand_ellipfilter_ccd.py --file=$START_PATH/ally3.riz --tag=$TAG --work=$INPUT_PATH/$TAG --outpath=$OUTPUT_PATH/$TAG/test3_beccd_e/allzones_e0.06 --bands=riz --threshold=0.06 --use_reserved #--bandcombo
