...
for(( n=1 ; n<= 215 ; n++ ))
do
    $INSTALL/pyhton/2714/install/bin/python $START_PATH/run_rho2_outand.py --file=$START_PATH/astro/riz/zone$n.riz --tag=$TAG --work=$INPUT_PATH/$TAG --outpath=$OUTPUT_PATH/$TAG/byzone/zone_$n/
    wait
done
