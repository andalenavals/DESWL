...
import os
import numpy as np
from read_psf_cats_andres_threshold_eorepiff_ccd import read_data
...
def parse_args():
    ...
    parser.add_argument('--work', default='/astro/u/mjarvis/work/y3_piff',
                        help='location of work directory the inpath of the catalog')
    ...
    parser.add_argument('--bandcombo', default=False, action='store_const', const=True, 
    ...
    parser.add_argument('--threshold', default=0.1, type=float,
                        help='Choose a upper limit for the ellipticity ')
...
def main():
    ...
    data, bands, tilings = read_data(exps, work, keys, limit_bands=args.bands, single_ccd=None, threshold= args.threshold,  prefix=prefix,
    ...
    do_canonical_stats(data, bands, tilings, outpath, alt_tt=False, prefix=prefix, bandcombo=args.bandcombo)
