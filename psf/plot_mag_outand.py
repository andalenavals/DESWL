...
def bin_by_mag(m, dT, de1, de2, min_mused, bands,  outpath):
    ...
    plt.tight_layout()
    plt.savefig(outpath + '/dpsf_mag_' + bands + '.png')
...
def make_hist(dT, T, de1, de2, bands,  outpath):
    ...
    plt.tight_layout()
    plt.savefig(outpath + '/dpsf_hist_' + bands + '.png')
...
def main():
    ...
    for bands in ['r', 'i', 'z', 'riz']:
        ...
        bin_by_mag(m[used], dT[used], de1[used], de2[used], min_mused, bands+'_used',  outpath)

        make_hist(dT, T, de1, de2, bands,  outpath)
        make_hist(dT[used], T[used], de1[used], de2[used], bands+'_used',  outpath)
